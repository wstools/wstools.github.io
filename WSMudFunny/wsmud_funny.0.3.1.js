...
(function() {
    ...
    let commands = {
        "快捷（会打断当前状态）": {
            "回宅修炼": ["stopstate", "jh fam 0 start", "go west", "go west", "go north", "go enter", "go west", "xiulian"],
            "回宅打坐": ["stopstate", "jh fam 0 start", "go west", "go west", "go north", "go enter", "go west", "dazuo"],
            "武庙疗伤": ["stopstate", "jh fam 0 start", "go north", "go north", "go west", "liaoshang"],
            "挖矿": ["stopstate", "wakuang"],
            "当铺清包": ["stopstate", "jh fam 0 start", "go south", "go east", "sell"],
        },
        "小号": {
            "配偶送花": ["greet 99"],
            "师傅请安": ["greet master"],
        ...
        "实验性指令": {
            "自动师门 不交牌子 不放弃": function() {
                let school = wsmud.role.family;
