...
// @require     http://code.jquery.com/jquery-3.3.1.min.js.cancel
// @require     https://cdn.jsdelivr.net/npm/jquery@1.12.4/dist/jquery.min.js
// @require     https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js.cancel
// @grant       unsafeWindow
// @grant       GM_addStyle
// @grant       GM_setValue
...
(function() {
    ...
    // $("head").append(`<link href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css" rel="stylesheet">`);
    ...
    // unsafeWindow.xxx = new WebSocket("ws://120.79.75.160:25632/");
    // unsafeWindow.xxx.onopen = function() {
    //     xxx.send("test");
    // }
    // unsafeWindow.xxx.onmessage = function(event) {
    //     console.log(event.data);
    // }
    // unsafeWindow.xxx.onclose = function(event) {
    //     console.log("onclose");
    // }
    // unsafeWindow.xxx.onerror = function(event) {
    //     console.log("onerror");
    // }
...
// {type: "dialog", dialog: "pack", id: "f1gv3f46fa9", remove: 40, money: 807271003}
    ...
    $(document).ready(function() {
        ...
        $(".left-role").append(`<table>
            ...
            <tr><td>银两</td><td colspan="3" class="role_lianxi_per"></td></tr>
        </table>`);
        $(".left-skill").append(`
